...
{
	public class ViewProductInDepartment :ApplicationCommand
	{
        DepartmentsRepository repository;
        Renderer renderer;

		public ViewProductInDepartment()
			: this(new StubDepartmentRepository(),
            new StubRenderer())
        {
        }

		public ViewProductInDepartment(DepartmentsRepository repository, Renderer renderer)
        {
